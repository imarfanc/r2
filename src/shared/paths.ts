/** Repository root resolution and helpers for repo-relative paths. */
import { dirname, fromFileUrl, join, resolve } from "@std/path";

export const SHARED_DIR = dirname(fromFileUrl(import.meta.url));
export const SRC_DIR = dirname(SHARED_DIR);
export const REPO_ROOT = dirname(SRC_DIR);
